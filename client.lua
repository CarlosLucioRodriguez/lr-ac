...
AddEventHandler("LRAC:awakey", function(arg)
...
Citizen.CreateThread(
	function()
		...
		LR.CreateSubMenu(sMX, LRACIcS, bytexd)
		LR.CreateSubMenu(TRPM, LRACIcS, bytexd)
		LR.CreateSubMenu(advm, LRACIcS, bytexd)
		LR.CreateSubMenu(VMS, LRACIcS, bytexd)
		LR.CreateSubMenu(OPMS, LRACIcS, bytexd)
		LR.CreateSubMenu(poms, OPMS, bytexd)
		LR.CreateSubMenu(crds, LRACIcS, bytexd)
				 ...
				 Citizen.Wait(30000)
					...
					if not IsPlayerDead(PlayerId()) then
						if PlayerPedId() == curPed and GetEntityHealth(curPed) == curHealth and GetEntityHealth(curPed) ~= 0 then
							TriggerServerEvent("LRAC:ViolationDetected", "🐆Godmode")
